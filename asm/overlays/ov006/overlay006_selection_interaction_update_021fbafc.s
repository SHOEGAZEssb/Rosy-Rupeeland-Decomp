    ...
    .extern Overlay006_UpdateAuxiliaryToggle

    /* Exact fallback; see the documented portable reconstruction in
     * src/overlays/ov006/overlay006_selection_interaction_update.c. */
    .global Overlay006_UpdateSelectionInteraction
Overlay006_UpdateSelectionInteraction: ; 0x021fbafc
    stmdb sp!, {r4, lr}
    mov r4, r0
    ldr r0, [r4, #0x4]
    cmp r0, #0x0
...
L_021fbbf0:
    mov r0, r4
    bl Overlay006_UpdateAuxiliaryToggle
    mov r0, #0x0
    ldmia sp!, {r4, pc}

    .size Overlay006_UpdateSelectionInteraction, .-Overlay006_UpdateSelectionInteraction
