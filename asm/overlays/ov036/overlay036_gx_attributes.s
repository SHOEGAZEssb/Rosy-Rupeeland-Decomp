...
L_021fd150: .word 0x40004a4
    .size func_ov036_021fd128, .-func_ov036_021fd128

    .global func_ov036_021fd154
func_ov036_021fd154:
    cmp r2, #0x0
    movne r2, #0x1
...
L_021fd174: .word 0x40004c0
    .size func_ov036_021fd154, .-func_ov036_021fd154

    .global func_ov036_021fd178
func_ov036_021fd178:
    cmp r2, #0x0
    movne r2, #0x1
    orr r1, r0, r1, lsl #0x10
...
L_021fd198: .word 0x40004c4
    .size func_ov036_021fd178, .-func_ov036_021fd178
