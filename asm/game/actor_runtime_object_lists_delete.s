...
.global ActorRuntimeAnimationResourceLists_DestroyAndFree
ActorRuntimeAnimationResourceLists_DestroyAndFree:
    stmdb sp!, {r4, lr}
    ldr r1, L_0200bcb0
    mov r4, r0
    str r1, [r4, #0x0]
    ...
    mov r0, r4
    ldmia sp!, {r4, pc}
L_0200bcb0: .word gActorRuntimeAnimationResourceListsVTable
L_0200bcb4: .word gActorRuntimeAnimationResourceListVTable
.size ActorRuntimeAnimationResourceLists_DestroyAndFree, . - ActorRuntimeAnimationResourceLists_DestroyAndFree
