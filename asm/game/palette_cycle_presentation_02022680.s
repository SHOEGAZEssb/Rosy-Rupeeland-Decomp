...
.global PaletteCyclePresentation_Destroy
    .type PaletteCyclePresentation_Destroy, @function
PaletteCyclePresentation_Destroy: ; 0x02022680
    stmdb sp!, {r4, lr}
    mov r4, r0
    mov r1, #0x0
    str r1, [r4, #0x444]
    ...
    mov r0, r4
    ldmia sp!, {r4, pc}
    .size PaletteCyclePresentation_Destroy, .-PaletteCyclePresentation_Destroy
