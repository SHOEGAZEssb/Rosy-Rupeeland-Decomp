...
.extern DualScreenUiPresentationBase_DestroyAlternateEntry
    ...
    .global DualScreenUiStandardPresentation_Destroy
    .type DualScreenUiStandardPresentation_Destroy, @function
DualScreenUiStandardPresentation_Destroy: ; 0x02025fc4
    stmdb sp!, {r4, lr}
    mov r4, r0
    add r0, r4, #0xc8
    ...
    mov r0, r4
    ldmia sp!, {r4, pc}
    .size DualScreenUiStandardPresentation_Destroy, . - DualScreenUiStandardPresentation_Destroy
