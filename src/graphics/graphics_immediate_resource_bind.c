 ...
 */
void Graphics3dPresentation_BindImmediateTexture(void *context, s32 resource, s32 polygonMisc)
{
    ...
    if (resource >= 0) {
        ...
        G3Command_SetTextureParameters(format, 1,
        ...
        G3Command_SetPolygonAttributes(0, 0, 3, 0, 0x1f, (u32)polygonMisc);
    } else {
