...
void func_0202cc88(MainThreeLayerResourceRenderer *);
#ifdef __cplusplus
}
#endif
...
void func_0202cc30(MainThreeLayerResourceRenderer *self)
{
    func_02029370(self);
...
void func_0202cc70(MainThreeLayerResourceRenderer *self)
{
    func_02029648(self);
    func_0202cc88(self);
}
 ...
 */
void func_0202cc88(MainThreeLayerResourceRenderer *self)
{
    ...
    *(volatile u32 *)0x04000018 = 0;
    ...
    PaletteBuffer_Write(&data_020f4e50, func_02070874(set.resource1), 0, 0xc0);
    ...
    *(volatile u32 *)0x04000014 = 0;
    ...
    PaletteBuffer_Write(&data_020f4e50, func_02070874(set.resource1),
                        0xc0, 0xc0);
    GraphicsResourceSet_ReleaseHandles(&set);
