...
s32 ActorExtendedType2_TryDescriptorInteraction128(void *self,const void *descriptorRecord)
{
 ...
 if((f&0x10)==0){void *p=*(void **)(gGamePhaseRuntime+0x2ea4);if((*(s32 (**)(void *,void *,const void *))(*(u8 **)a+0x128))(a,p,d))return 1;}
 if((f&0x20)!=0){u8 *p=*(u8 **)(gGamePhaseRuntime+0x2ea8);if(p!=0&&(*(u32 *)(p+0x268)&0x10)!=0&&(*(s32 (**)(void *,void *,const void *))(*(u8 **)a+0x128))(a,p,d))return 1;}
 return 0;
}
