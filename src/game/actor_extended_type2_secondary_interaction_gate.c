...
#ifdef __cplusplus
extern "C" { extern s32 func_020401a0(const void *actor,s32 unused); }
#endif

/*
 * Require descriptor +0x1a bit two and reject when func_020401a0 is nonzero.
 ...
 */
s32 func_02040334(void *self,const void *descriptorRecord)
{
 u8 *a=(u8 *)self;const u8 *d=(const u8 *)descriptorRecord;u16 f=*(u16 *)(d+0x1a);
 if((f&4)==0||func_020401a0(a,f))return 0;
