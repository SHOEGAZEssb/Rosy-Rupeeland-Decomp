...
#ifdef __cplusplus
extern "C" { extern s32 func_0204305c(void *self,u32 kind,void *other); }
#endif

/*
 * Require func_0204305c(self, descriptor +0x1e low two bits, other), reject
...
s32 func_02040284(void *self,void *other,const void *descriptorRecord)
{
 ...
 if(!func_0204305c(a,*(u16 *)(d+0x1e)&3,o)||(*(u32 *)(o+0xd0)&0x100)!=0)return 0;
