...
extern "C" {
#endif
extern s32 ActorExtendedType2_MatchesInteractionCallbackPairs(void *actor, s32 value);
#ifdef __cplusplus
}
#endif
 ...
 * positive signed +0x16, then reject when
 * ActorExtendedType2_MatchesInteractionCallbackPairs(actor, +0x16) is nonzero.
 ...
 */
s32 ActorExtendedType2_TryDescriptorInteraction120(void *self, const void *descriptorRecord)
{
