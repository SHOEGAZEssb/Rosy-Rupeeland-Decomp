...
/* Multiply the encoded destination by the encoded source, update the condition
...
/* Multiply the byte-selected register by a 32-bit immediate, update the
...
/* Divide the encoded destination by the encoded source, update the condition
 * to reflect whether the destination result is zero, and return zero. */
...
/* Divide the byte-selected register by a 32-bit immediate, update the condition
 * to reflect whether the destination result is zero, and return zero. */
...
/* Store destination modulo the encoded source, update the condition to reflect
 * whether the destination result is zero, and return zero. */
...
/* Store destination modulo a 32-bit immediate, update the condition to reflect
 * whether the destination result is zero, and return zero. */
