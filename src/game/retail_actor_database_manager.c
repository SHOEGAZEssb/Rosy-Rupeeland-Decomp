    ...
    *(u32 *)(database + 0x2dc) = count;
    for (index = 0; index < count; ++index) {
        ...
        *(u16 *)(record + 6) =
        ...
        func_02078dd4(data_021f4090, ReadU16(input + 4), record + 8, 0x60);
        *(void **)(record + 0x68) =
    ...
    *(u32 *)(database + 0x2c4) = count;
    for (index = 0; index < count; ++index) {
        ...
        *(u32 *)(record + 0x0c) = ReadU32(input + 8);
        func_02078dd4(data_021f4090, ReadU16(input + 6), record + 0x10,
                      0x60);
        if (type == 0) {
...
void func_02063b14(void *database)
{
    ...
    *(void **)((u8 *)database + 0x258) = FindActorRecord(database, 0x40);
    func_02078dd4(data_021f4090, 0x11c5, (u8 *)database + 0x25c, 0x40);
}
