 ...
 */
TimedSpritePresentation *TimedSpritePresentation_Init(
    TimedSpritePresentation *self, u8 *config)
{
 ...
 * without freeing it. */
TimedSpritePresentation *TimedSpritePresentation_Destroy(
    TimedSpritePresentation *self)
{
    self->vtable=data_020d6098;
...
/* Perform the standard teardown, free self, and return its old address. */
TimedSpritePresentation *TimedSpritePresentation_DestroyAndFree(
    TimedSpritePresentation *self)
{
    self->vtable=data_020d6098;
    GraphicsSpriteGroup_ReleaseState(*(void **)self->sprite, self->sprite);
...
TimedSpritePresentation *TimedSpritePresentation_DestroyBase(
    TimedSpritePresentation *self)
{
    self->vtable=data_020d6098;
    GraphicsSpriteGroup_ReleaseState(*(void **)self->sprite, self->sprite);
 ...
 */
s32 TimedSpritePresentation_Update(
    TimedSpritePresentation *self, s32 positionSampleArgument)
{
    s32 sample[4];
    self->remaining28--;
    if(self->remaining28<0){TimedSpritePresentation_SetVisible(self,0);return 1;}
    VecFx32Object_Add(&self->first08,&self->second18);
    VecFx32_Subtract(sample,&self->first08,positionSampleArgument);
