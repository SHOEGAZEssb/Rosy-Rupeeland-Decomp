...
/*
 * Drain the actor collection's active-pointer array when its dirty flag is
 * set. Each active actor is removed from collection bookkeeping, destroyed
 * through vtable offset 0x04, and cleared from the active slot.
 */
 ...
 */
void func_0202d5c8(ActorCollectionActiveDrain *self)
{
    s32 i;
