...
extern "C" {
#endif
extern void GraphicsSpriteState_SetAnimationIndex(void *object, u8 value);
 ...
 * that result to GraphicsSpriteState_SetAnimationIndex on actor->0x54, then send step<<13 to actor
