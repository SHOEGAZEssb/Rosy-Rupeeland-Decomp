...
extern void *GraphicsSpriteGroup_CreateState(void *context, void *first, void *second, void *third,
                          u32 mode);
#ifdef __cplusplus
}
#endif
 ...
 * the three actor fields, and descriptor byte +0x10 to GraphicsSpriteGroup_CreateState; store its
...
void Type7Actor_SetupResources(void *self, const void *descriptor)
{
    ...
    *(u32 *)((u8 *)*(void **)(actor + 0x1f0) + 0x28) |= 0x01000000;
    ...
    resource = GraphicsSpriteGroup_CreateState(context, *(void **)(actor + 0x1f0),
                             *(void **)(actor + 0x1f4),
