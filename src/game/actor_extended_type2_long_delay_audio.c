...
extern s32 func_0204362c(void *actor);
 ...
 * signed byte +0x27e is zero, classify actor with func_0204362c: result zero
...
s32 func_02042170(void *self)
{
    ...
    if (counter == 0) {
        *(u16 *)(actor + 0x258) =
        ...
        if (*(s8 *)(actor + 0x27e) == 0) {
            s32 variant = func_0204362c(actor);
            if (variant == 0)
        ...
        *(u32 *)(actor + 0x260) |= 0x400000;
        if (*(s8 *)(actor + 0x27e) == 0 && func_0204362c(actor) == 0)
