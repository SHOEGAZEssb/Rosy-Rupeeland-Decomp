 ...
 * record via func_020390c8, copy actor position +0x18 to a temporary, obtain a
 ...
 * func_02038f98 and destroy the temporary. Returns no value; record, object,
 * vector, and sound helpers have observable engine/SDK effects.
 */
void func_02038ecc(void *self, void *records)
{
    u8 *actor = (u8 *)self;
    u8 *descriptor;
    s32 position[4];
