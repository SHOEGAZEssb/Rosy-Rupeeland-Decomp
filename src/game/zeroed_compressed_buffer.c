...
extern const char data_020deb4c[];
...
void func_0202b620(ZeroedCompressedBuffer *self);
#ifdef __cplusplus
}
#endif

/* Initialize an empty buffer and zero its recorded expanded size. */
void func_0202b5fc(ZeroedCompressedBuffer *self)
{
    self->bytes_00 = 0;
...
ZeroedCompressedBuffer *func_0202b60c(ZeroedCompressedBuffer *self)
{
    func_0202b620(self);
    return self;
}
 ...
 */
s32 func_0202b648(ZeroedCompressedBuffer *self, GameFile *file,
...
u8 *func_0202b728(ZeroedCompressedBuffer *self)
{
