...
extern "C" {
#endif
extern void *func_02009d78(void *state);
 ...
 * reference X (manager+0x2fbc resolved through func_02009d78), subtracting
...
void func_020349b8(void *self, u32 sound, s32 extra)
{
    ...
    reference = (u8 *)func_02009d78((u8 *)data_021052fc + 0x2fbc);
...
{
    u8 *actor = (u8 *)self;
    u8 *reference = (u8 *)func_02009d78((u8 *)data_021052fc + 0x2fbc);
