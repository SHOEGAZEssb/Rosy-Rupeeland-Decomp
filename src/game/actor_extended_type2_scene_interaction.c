...
extern void func_02038d38(void *primary, const void *position, s32 value, s32 extra);
 ...
 * transform +0x18 with value 20 and extra zero through func_02038d38 and notify
    ...
    if (*(u32 *)(scene + 4) == 1) {
        ...
        if ((*(u32 *)(actor + 0x260) & 2) != 0 &&
            ...
            if (func_02039c3c(primary, actor) != 0) {
                func_02038d38(primary, actor + 0x18, 20, 0);
