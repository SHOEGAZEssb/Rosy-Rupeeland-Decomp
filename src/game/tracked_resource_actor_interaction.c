...
extern "C" {
#endif
extern void func_020398a4(void *target, s32 value);
 ...
 * flag 0x1000000. For target type byte 1, call func_020398a4 with signed record
...
void func_02050560(void *actor, void *target, u32 unused, u32 argument)
{
    ...
    if (FIELD(u8, target, 0x4d) == 1) {
        func_020398a4(target, FIELD(s16, record, 0x0c));
