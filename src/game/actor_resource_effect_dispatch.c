 ...
 * one, otherwise offset 0x5cc. Dispatch it through gActorRuntimeCollection and destroy
...
void Actor_AssignPrimaryResourceWithEffect(void *self, void *resource)
{
    ...
    *(void **)(actor + 0x180) = resource;
    ...
    ActorRuntimeCollection_CopyPrimaryContainerState(gActorRuntimeCollection, temporary);
