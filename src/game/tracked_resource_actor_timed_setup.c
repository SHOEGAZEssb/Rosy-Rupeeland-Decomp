 ...
 * 0x38, applies signed record byte 0x15, clamps a magnitude-derived divisor to
 * at least 4, divides the vector by it, and scales it by record halfword 0x0A
 * shifted four bits. It then forces
