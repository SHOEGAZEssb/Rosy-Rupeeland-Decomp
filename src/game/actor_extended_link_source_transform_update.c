...
extern void func_0203efac(void *context, void *actor, void *record);
#ifdef __cplusplus
}
#endif
 ...
 * func_0203efac. While actor flags +0x29c bit zero are set, obtain a fixed-point
 * value from vtable +0x1e0, use it to form a temporary transform-like value,
...
void func_02043f10(void *context, void *self, void *record)
{
    ...
    func_0203efac(context, actor, record);
    partner = *(void **)(actor + 0x298);
