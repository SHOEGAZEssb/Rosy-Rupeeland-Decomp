...
#ifdef __cplusplus
extern "C" {extern void Actor_PlayHorizontalSpatialSound(void *actor,u32 packedSound,s32 pitch);extern void *TimedSpriteOffsetPresentation_Init(void *allocation,...);extern void PresentationList_AppendObject(void *manager,void *presentation);}
#endif
