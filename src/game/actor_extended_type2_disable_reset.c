 ...
 * attachment +0x54 exists, set its +0x24 bit 0x10. Invoke
 * Actor_SaveAndForceFlags and release this actor's optional +0x274 record
 * reservations. Copy global pair +0x80/+0x84 to +0x218/+0x21c, clear +0x260
 * bits zero/one, set +0xd0 bit 0x100, and store 0xff at halfword +0xac.
 * Returns no value; actor, attachment, and optional allocator state change.
 */
void ActorExtendedType2_DisableModesAndSetCallbackPair80(void *self)
{
    ...
    *(u32 *)(actor+0xd0)&=~0x200; *(u32 *)(actor+0x260)&=~0x800; *(u16 *)(actor+0x24e)=0;
    ...
    Actor_SaveAndForceFlags(actor); if (*(void **)(actor+0x274)!=0) InteractionRecordAllocator_ReleaseOwner(*(void **)(actor+0x274), actor);
