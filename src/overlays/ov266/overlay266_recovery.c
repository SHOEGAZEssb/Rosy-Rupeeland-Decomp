/*
 * Recovered overlay 266 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov266_0221d72c[], data_ov266_0221d740[];
extern unsigned char data_ov266_0221f130[], data_ov266_022218e0[];
extern unsigned char data_ov266_022218e4[];
...
void func_ov266_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov266_022218e4, 3, data_ov266_0221d740);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov266_0221d72c);
    ActorDescriptorBatch_SetCategory1Callback(data_ov266_0221f130);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov266_0221d72c[];
extern unsigned char data_ov266_0221d740[];
extern unsigned char data_ov266_0221f130[];
extern unsigned char data_ov266_022218e0[];
extern unsigned char data_ov266_022218e4[];
