/*
 * Recovered overlay 180 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov180_0221d720[], data_ov180_0221dde5[];
extern unsigned char data_ov180_0221e060[], data_ov180_0221e064[];
extern unsigned char data_ov180_0221e068[];
...
void func_ov180_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov180_0221e064, 3, data_ov180_0221e068);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov180_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov180_0221dde5);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov180_0221d720[];
extern unsigned char data_ov180_BSSSTART[];
