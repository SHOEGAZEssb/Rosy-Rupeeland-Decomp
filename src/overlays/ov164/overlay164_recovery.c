/*
 * Recovered overlay 164 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov164_0221d734[], data_ov164_0221d748[];
extern unsigned char data_ov164_0221edac[], data_ov164_0222ce60[];
extern unsigned char data_ov164_0222ce64[];
...
void func_ov164_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov164_0222ce64, 3, data_ov164_0221d748);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov164_0221d734);
    ActorDescriptorBatch_SetCategory1Callback(data_ov164_0221edac);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov164_0221d720[];
extern unsigned char data_ov164_BSSSTART[];
