/*
 * Recovered overlay 290 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov290_0221d720[], data_ov290_0221d734[];
extern unsigned char data_ov290_0221e425[], data_ov290_02221b20[];
extern unsigned char data_ov290_02221b24[];
...
void func_ov290_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov290_02221b24, 3, data_ov290_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov290_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov290_0221e425);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov290_0221d720[];
extern unsigned char data_ov290_0221d734[];
extern unsigned char data_ov290_0221e425[];
extern unsigned char data_ov290_02221b20[];
extern unsigned char data_ov290_02221b24[];
