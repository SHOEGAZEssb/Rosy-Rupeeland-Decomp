...
extern unsigned char data_ov274_0221d720[], data_ov274_0221d860[];
extern unsigned char data_ov274_0221f7c8[], data_ov274_02221fc4[];
...
void func_ov274_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov274_02221fc0, 3, data_ov274_0221d860);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov274_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov274_0221f7c8);
}
