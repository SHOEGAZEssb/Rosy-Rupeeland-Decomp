/*
 * Recovered overlay 273 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov273_0221d730[], data_ov273_0221d744[];
extern unsigned char data_ov273_0221f3f0[], data_ov273_02223f60[];
extern unsigned char data_ov273_02223f64[];
...
void func_ov273_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov273_02223f64, 3, data_ov273_0221d744);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov273_0221d730);
    ActorDescriptorBatch_SetCategory1Callback(data_ov273_0221f3f0);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov273_0221d730[];
extern unsigned char data_ov273_0221d744[];
extern unsigned char data_ov273_0221f3f0[];
extern unsigned char data_ov273_02223f60[];
extern unsigned char data_ov273_02223f64[];
