/*
 * Recovered overlay 269 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov269_0221d734[], data_ov269_0221d748[];
extern unsigned char data_ov269_0221f19c[], data_ov269_02221340[];
extern unsigned char data_ov269_02221344[];
...
void func_ov269_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov269_02221344, 3, data_ov269_0221d748);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov269_0221d734);
    ActorDescriptorBatch_SetCategory1Callback(data_ov269_0221f19c);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov269_0221d734[];
extern unsigned char data_ov269_0221d748[];
extern unsigned char data_ov269_0221f19c[];
extern unsigned char data_ov269_02221340[];
extern unsigned char data_ov269_02221344[];
