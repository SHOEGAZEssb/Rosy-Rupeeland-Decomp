/*
 * Recovered overlay 122 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov122_0221d720[], data_ov122_0221d824[];
extern unsigned char data_ov122_0221ea6d[], data_ov122_02225e04[];
 ...
 */
void func_ov122_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov122_02225e04,
        3, data_ov122_0221d824);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov122_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov122_0221ea6d);
}

/* Exact initialized records and zero-initialized work fields used by the overlay. */
extern unsigned char data_ov122_0221d720[];
extern unsigned char data_ov122_02225e00[];
