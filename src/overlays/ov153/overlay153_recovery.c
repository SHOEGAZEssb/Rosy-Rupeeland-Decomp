/*
 * Recovered overlay 153 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov153_0221d72c[], data_ov153_0221d740[];
extern unsigned char data_ov153_0221eada[], data_ov153_02227de0[];
extern unsigned char data_ov153_02227de4[];
...
void func_ov153_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov153_02227de4, 3, data_ov153_0221d740);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov153_0221d72c);
    ActorDescriptorBatch_SetCategory1Callback(data_ov153_0221eada);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov153_0221d720[];
extern unsigned char data_ov153_02227de0[];
