/*
 * Recovered overlay 291 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov291_0221d720[], data_ov291_0221d734[];
extern unsigned char data_ov291_0221ecbd[], data_ov291_02225740[];
extern unsigned char data_ov291_02225744[];
...
void func_ov291_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov291_02225744, 3, data_ov291_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov291_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov291_0221ecbd);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov291_0221d720[];
extern unsigned char data_ov291_0221d734[];
extern unsigned char data_ov291_0221ecbd[];
extern unsigned char data_ov291_02225740[];
extern unsigned char data_ov291_02225744[];
