/*
 * Recovered overlay 285 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov285_0221d734[];
extern unsigned char data_ov285_0221e3b5[];
extern unsigned char data_ov285_0221e440[];
