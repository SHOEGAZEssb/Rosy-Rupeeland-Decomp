/*
 * Recovered overlay 220 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov220_0221d734[], data_ov220_0221d764[];
extern unsigned char data_ov220_0221ed90[], data_ov220_02225320[];
extern unsigned char data_ov220_02225324[];
...
void func_ov220_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov220_02225320, 3, data_ov220_0221d764);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov220_0221d734);
    ActorDescriptorBatch_SetCategory1Callback(data_ov220_0221ed90);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov220_0221d734[];
extern unsigned char data_ov220_0221d764[];
extern unsigned char data_ov220_0221ed90[];
extern unsigned char data_ov220_02225320[];
extern unsigned char data_ov220_02225324[];
