/*
 * Recovered overlay 146 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov146_0221d730[], data_ov146_0221d7a4[];
extern unsigned char data_ov146_0221ec5c[], data_ov146_0221d720[];
 ...
 * direct SDK or hardware access. The literal 15 is retained from retail.
 */
void func_ov146_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov146_0221d720, 15, data_ov146_0221d7a4);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov146_0221d730);
    ActorDescriptorBatch_SetCategory1Callback(data_ov146_0221ec5c);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov146_0221d720[];
extern unsigned char data_ov146_022279c0[];
