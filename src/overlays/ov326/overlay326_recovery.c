/*
 * Recovered overlay 326 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov326_0221d720[], data_ov326_0221d734[];
extern unsigned char data_ov326_0221f48d[], data_ov326_02228e20[];
extern unsigned char data_ov326_02228e24[];
...
void func_ov326_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov326_02228e24, 3, data_ov326_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov326_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov326_0221f48d);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov326_0221d720[];
extern unsigned char data_ov326_0221d734[];
extern unsigned char data_ov326_0221f48d[];
extern unsigned char data_ov326_02228e20[];
extern unsigned char data_ov326_02228e24[];
