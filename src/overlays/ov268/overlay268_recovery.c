...
extern unsigned char data_ov268_0221d734[], data_ov268_0221d748[];
extern unsigned char data_ov268_0221f6b0[], data_ov268_02225460[];
...
void func_ov268_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov268_02225464, 3, data_ov268_0221d748);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov268_0221d734);
    ActorDescriptorBatch_SetCategory1Callback(data_ov268_0221f6b0);
}
