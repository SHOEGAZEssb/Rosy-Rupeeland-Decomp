...
extern s32 func_020629a0(void *);
extern s32 func_02062a60(void *);
extern s32 func_02062ae4(void *);
...
static void overlay016_load_row_resource(void *resource, void *row)
{
    ...
    value = func_02062918(row, 0);
    first = func_02063064(value);
    value = func_02062918(row, 0);
    second = func_02063074(value);
    value = func_02062918(row, 0);
    func_02071ee0(resource, data_020f4e18, first, second, func_02063084(value));
}
...
extern "C" void func_ov016_021fdaa0(void *state, void *selection, s32 image)
{
...

    {
        ...
        func_02076148(FIELD(void *, state, 0), func_020628c8(header),
                      0x59, 0x27, 0xe, 6, 0);
        func_02075598(FIELD(void *, state, 0), (u8 *)state + 0xd8);
        ...
        for (i = 0; i < 6; i++) {
            ...
            if (i < count) {
                ...
                func_02075598(FIELD(void *, state, 0), (u8 *)state + 0xd4);
