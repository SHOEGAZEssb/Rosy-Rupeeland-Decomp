...
extern void SpriteMotionController_BindSprite(void *element, void *sprite, s32 animation,
                           s32 mode, s32 flags);
extern void SpriteMotionController_SetPosition(void *element, s32 width, s32 height);
...
extern "C"
#endif
Overlay001GridState *Overlay001_Grid_Init(Overlay001GridState *state,
                                         void *owner)
{
    s32 index;
    s32 rawCount;
    ...
    SpriteMotionController_Init(state->element_028);
    SpriteMotionController_Init(state->element_0d4);
    ...
    SpriteMotionController_BindSprite(state->element_028, sprite, 0x3a, 2, 0);
    SpriteMotionController_SetPosition(state->element_028, 0xec, 0xaa);
    SpriteMotionController_Hide(state->element_028);
    sprite = GraphicsSpriteGroup_CreateStateFromSource(state->spriteGroup_00c, state->resource_010, 1);
    SpriteMotionController_BindSprite(state->element_0d4, sprite, 0x42, 2, 0);
    SpriteMotionController_SetPosition(state->element_0d4, 0xdc, 0x10);
    SpriteMotionController_Hide(state->element_0d4);
    TitleCharacterResourceCollection_Append(state->rendererState_180, 0x7004);
