/*
 * Recovered overlay 396 interpreter-data subsystem.
 *
...
extern unsigned char data_ov396_02233ca0[];
extern unsigned char data_ov396_02233cb0[];
extern unsigned char data_ov396_0223437a[];
extern unsigned char data_ov396_022343a0[];
