...
/* Recovered overlay 593 category-two actor-registration subsystem. */
...
extern u8 data_ov593_02234900[];
extern GamePhaseRegionTable data_ov593_02234904;
extern ActorScriptBytecode data_ov593_022348e2[];
extern ActorSpawnDescriptor data_ov593_02233ca0[];
...
void func_ov593_02233c60(void)
{
    ActorDescriptorBatch_RegisterAndSpawnCategory2(
        data_ov593_02234900, 3, data_ov593_02233ca0);
    ActorDescriptorBatch_SetCategory2Callback(data_ov593_022348e2);
    GamePhaseRegionTable_PublishActive(&data_ov593_02234904);
}
