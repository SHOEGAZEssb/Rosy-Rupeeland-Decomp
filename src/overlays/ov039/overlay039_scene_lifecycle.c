...
extern void Graphics3dPresentation_LoadResourceProfile(void *resource, s32 mode);
...
extern "C" void *func_ov039_02200cd8(void *scene, void *owner, s32 variant)
{
    ...
    Graphics3dPresentation_LoadResourceProfile(RuntimePresentationManager_GetGraphics3dPresentation((u8 *)FIELD(void *, gGamePhaseRuntime, 0) +
                                0x2f7c), 7);
