/*
 * Recovered overlay 298 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov298_0221d720[], data_ov298_0221d734[];
extern unsigned char data_ov298_0221ee4d[], data_ov298_02222ba0[];
extern unsigned char data_ov298_02222ba4[];
...
void func_ov298_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov298_02222ba4, 3, data_ov298_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov298_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov298_0221ee4d);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov298_0221d720[];
extern unsigned char data_ov298_0221d734[];
extern unsigned char data_ov298_0221ee4d[];
extern unsigned char data_ov298_02222ba0[];
extern unsigned char data_ov298_02222ba4[];
