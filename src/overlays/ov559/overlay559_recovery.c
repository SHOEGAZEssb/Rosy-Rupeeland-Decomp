...
/* Recovered overlay 559 category-two actor-registration subsystem. */
...
extern u8 data_ov559_02234520[];
extern GamePhaseRegionTable data_ov559_02234524;
extern ActorScriptBytecode data_ov559_022344fa[];
extern ActorSpawnDescriptor data_ov559_02233ca0[];
...
void func_ov559_02233c60(void)
{
    ActorDescriptorBatch_RegisterAndSpawnCategory2(
        data_ov559_02234520, 3, data_ov559_02233ca0);
    ActorDescriptorBatch_SetCategory2Callback(data_ov559_022344fa);
    GamePhaseRegionTable_PublishActive(&data_ov559_02234524);
}
