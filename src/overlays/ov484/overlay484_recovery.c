...
/* Recovered overlay 484 category-two actor-registration subsystem. */
...
extern u8 data_ov484_02234700[];
extern GamePhaseRegionTable data_ov484_02234704;
extern ActorScriptBytecode data_ov484_02234496[];
extern ActorSpawnDescriptor data_ov484_02233ca0[];
...
void func_ov484_02233c60(void)
{
    ActorDescriptorBatch_RegisterAndSpawnCategory2(
        data_ov484_02234700, 3, data_ov484_02233ca0);
    ActorDescriptorBatch_SetCategory2Callback(data_ov484_02234496);
    GamePhaseRegionTable_PublishActive(&data_ov484_02234704);
}
