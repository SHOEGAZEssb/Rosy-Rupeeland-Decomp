/*
 * Recovered overlay 292 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov292_0221d720[], data_ov292_0221d734[];
extern unsigned char data_ov292_0221e1cd[], data_ov292_02220840[];
extern unsigned char data_ov292_02220844[];
...
void func_ov292_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov292_02220844, 3, data_ov292_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov292_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov292_0221e1cd);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov292_0221d720[];
extern unsigned char data_ov292_0221d734[];
extern unsigned char data_ov292_0221e1cd[];
extern unsigned char data_ov292_02220840[];
extern unsigned char data_ov292_02220844[];
