/*
 * Recovered overlay 132 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov132_0221d72c[], data_ov132_0221d740[];
extern unsigned char data_ov132_0221e95e[], data_ov132_0222c784[];
 ...
 */
void func_ov132_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov132_0222c784,
        3, data_ov132_0221d740);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov132_0221d72c);
    ActorDescriptorBatch_SetCategory1Callback(data_ov132_0221e95e);
}

/* Exact initialized records and zero-initialized work fields used by the overlay. */
extern unsigned char data_ov132_0221d720[];
extern unsigned char data_ov132_0222c780[];
