/*
 * Recovered overlay 309 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov309_0221d734[], data_ov309_0221d748[];
extern unsigned char data_ov309_0221f714[], data_ov309_02225340[];
extern unsigned char data_ov309_02225344[];
...
void func_ov309_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov309_02225344, 3, data_ov309_0221d748);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov309_0221d734);
    ActorDescriptorBatch_SetCategory1Callback(data_ov309_0221f714);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov309_0221d734[];
extern unsigned char data_ov309_0221d748[];
extern unsigned char data_ov309_0221f714[];
extern unsigned char data_ov309_02225340[];
extern unsigned char data_ov309_02225344[];
