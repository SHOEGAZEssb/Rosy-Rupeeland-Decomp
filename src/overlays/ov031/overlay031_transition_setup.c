...
extern "C" void func_ov031_021fdfa8(void *scene)
{
    ...
    func_020b44e8();
    GraphicsBgCharacterResource_UploadToSubBg((void *)resources[0], 0, 0);
    GraphicsBgPaletteResource_UploadToSubBg((void *)resources[1], 0);
    GraphicsBgMapResource_UploadToSubBg((void *)resources[2], 0, 0);
    GraphicsResourceSet_ReleaseHandles(resources);
    GraphicsResourceSet_Load(resources, data_020f4e18[0],
                             0x900c, 0x9008, 0x900d);
    func_020b44e8();
    GraphicsBgCharacterResource_UploadToSubBg((void *)resources[0], 1, 0);
    GraphicsBgPaletteResource_UploadToSubBg((void *)resources[1], 0x6000);
...
extern "C" void func_ov031_021fe1a8(void *scene)
{
    ...
    func_020b44e8();
    GraphicsBgCharacterResource_UploadToSubBg((void *)resources[0], 0, 0);
    GraphicsBgPaletteResource_UploadToSubBg((void *)resources[1], 0x4000);
    GraphicsBgMapResource_UploadToSubBg((void *)resources[2], 0, 0);
