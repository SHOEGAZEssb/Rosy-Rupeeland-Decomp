...
extern "C" void SpriteMotionController_Init(void *canvas);
extern "C" void OverlaySlot_Init(void *object);
extern "C" void SpriteMotionController_SetPosition(void *canvas, s32 width, s32 height);
extern "C" void TitleCharacterResourceCollection_Append(void *object, s32 resourceId);
...
extern "C" void *func_ov043_0220b76c(void *object)
{
    ...
    SpriteMotionController_Init((u8 *)object + 0x90);
    SpriteMotionController_Init((u8 *)object + 0x13c);
    SpriteMotionController_Init((u8 *)object + 0x1e8);
    ...
    SpriteMotionController_SetPosition((u8 *)object + 0x13c, 0x48, 0x50);
    SpriteMotionController_SetPosition((u8 *)object + 0x1e8, 0xb8, 0x50);
    SpriteMotionController_SetPosition((u8 *)object + 0x90, 0xe8, 0xa0);
    TitleCharacterResourceCollection_Append((u8 *)object + 0x5c, 0x7005);
