...
extern unsigned char data_ov308_0221d730[], data_ov308_0221d744[];
extern unsigned char data_ov308_0221f328[], data_ov308_02224f80[];
...
void func_ov308_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov308_02224f84, 3, data_ov308_0221d744);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov308_0221d730);
    ActorDescriptorBatch_SetCategory1Callback(data_ov308_0221f328);
}
