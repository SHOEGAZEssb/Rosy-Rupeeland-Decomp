...
extern unsigned char data_ov327_0221d720[], data_ov327_0221d734[];
extern unsigned char data_ov327_0221e7a9[], data_ov327_02222b00[];
...
void func_ov327_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov327_02222b04, 3, data_ov327_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov327_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov327_0221e7a9);
}
