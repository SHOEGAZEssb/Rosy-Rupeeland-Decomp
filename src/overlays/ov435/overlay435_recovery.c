...
/* Recovered overlay 435 category-two actor-registration subsystem. */
...
extern u8 data_ov435_022346a0[];
extern GamePhaseRegionTable data_ov435_022346a4;
extern ActorScriptBytecode data_ov435_02234432[];
extern ActorSpawnDescriptor data_ov435_02233ca0[];
...
void func_ov435_02233c60(void)
{
    ActorDescriptorBatch_RegisterAndSpawnCategory2(
        data_ov435_022346a0, 3, data_ov435_02233ca0);
    ActorDescriptorBatch_SetCategory2Callback(data_ov435_02234432);
    GamePhaseRegionTable_PublishActive(&data_ov435_022346a4);
}
