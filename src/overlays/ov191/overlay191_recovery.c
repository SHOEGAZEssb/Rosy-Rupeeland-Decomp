/*
 * Recovered overlay 191 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov191_0221d720[], data_ov191_0221d734[], data_ov191_0221ec59[], data_ov191_0221fb40[], data_ov191_0221fb44[];
...
void func_ov191_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov191_0221fb44, 3, data_ov191_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov191_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov191_0221ec59);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov191_0221d720[];
extern unsigned char data_ov191_BSSSTART[];
