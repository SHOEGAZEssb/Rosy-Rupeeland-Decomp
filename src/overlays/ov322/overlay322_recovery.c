...
extern unsigned char data_ov322_0221d72c[], data_ov322_0221d740[];
extern unsigned char data_ov322_0221f2a5[], data_ov322_02226820[];
...
void func_ov322_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov322_02226824, 3, data_ov322_0221d740);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov322_0221d72c);
    ActorDescriptorBatch_SetCategory1Callback(data_ov322_0221f2a5);
}
