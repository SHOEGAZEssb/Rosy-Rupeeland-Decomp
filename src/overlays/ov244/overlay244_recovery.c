/*
 * Recovered overlay 244 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov244_0221d720[], data_ov244_0221d734[];
extern unsigned char data_ov244_0221e4fb[], data_ov244_02220ca0[];
extern unsigned char data_ov244_02220ca4[];
...
void func_ov244_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov244_02220ca4, 3, data_ov244_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov244_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov244_0221e4fb);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov244_0221d720[];
extern unsigned char data_ov244_0221d734[];
extern unsigned char data_ov244_0221e4fb[];
extern unsigned char data_ov244_02220ca0[];
extern unsigned char data_ov244_02220ca4[];
