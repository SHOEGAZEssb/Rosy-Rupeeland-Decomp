...
extern "C" u8 data_ov082_022145e8[], data_ov082_022145f0[],
    data_ov082_02214668[];
extern "C" u8 data_ov082_0221483c[], data_ov082_022148d0[],
    data_ov082_02214aa4[];
extern "C" u8 data_ov082_02214aac[], data_ov082_02214abc[],
    data_ov082_02214ac4[], data_ov082_02214b18[];
...
extern "C" void *Heap_Alloc(u32, const void *, u32, void *);
...
static bool pair_is(void *a, const void *callbacks, u32 co, const void *tag) {
    void *c = F(void *, callbacks, co);
    return F(void *, a, 0x218) == c &&
           (F(void *, a, 0x21c) == F(void *, tag, 4) || c == 0);
}
/* Copy one initialized callback pair into the actor. */
static void set_pair(void *a, const void *d, u32 o) {
    F(void *, a, 0x218) = F(void *, d, o);
    F(void *, a, 0x21c) = F(void *, d, o + 4);
}
...
extern "C" void *func_ov082_02212ae0(void *a, const void *c) {
    ActorExtendedType2_Init(a, c);
    F(void *, a, 0) = data_ov082_02214668;
    return a;
}
/* Destroy the primary actor while retaining its allocation. */
extern "C" void *func_ov082_02212b00(void *a) {
    ActorExtendedType2_Destroy(a);
    return a;
}
/* Destroy and free the primary actor. */
extern "C" void *func_ov082_02212b14(void *a) {
    ActorExtendedType2_Destroy(a);
    Heap_Free(a);
    return a;
}
...
extern "C" void func_ov082_02212b30(void *a) {
    ...
    switch (F(s16, a, 0xd6)) {
    case 1:
        attachment = ActorExtendedType2_GetDescriptorValue25(a);
        if (attachment < 0) {
            n = F(u8, a, 0xd4) + 8;
            alpha = 0;
            stop = true;
            ...
            n = F(u8, a, 0xd4) +
                (F(s32, a, 0x24) < Actor_GetCachedTerrainHeight(a) + 0x8000
                     ? 8
                     : 0x16);
        break;
    case 2:
    ...
    case 4:
        attachment = ActorExtendedType2_GetDescriptorValue25(a);
        n = F(u8, a, 0xd4) +
            (attachment < 0 || F(s32, a, 0x24) < F(s32, a, 0x238) + 0x14000
                 ? 8
                 : 0x16);
        break;
    case 5:
    case 6:
        attachment = ActorExtendedType2_GetDescriptorValue25(a);
        n = F(u8, a, 0xd4) +
            (attachment >= 0 && F(s16, a, 0xda) == 1 ? 0x16 : 0);
        break;
    case 7:
        if (data_020e6c0c[F(u16, a, 0x4e)]) {
            n = F(u8, a, 0xd4) + 0x15;
            stop = true;
        } else {
            attachment = ActorExtendedType2_GetDescriptorValue25(a);
    ...
    F(u16, s, 0x36) = (u16)alpha;
    F(u16, s, 0x30) = 0;
    if (stop)
        F(u16, s, 0x24) &= ~3u;
    else
        F(u16, s, 0x24) = (F(u16, s, 0x24) & ~1u) | 2;
}

/* Advance vertical attachment motion, clamp terrain height, and expose height
 * bands. */
extern "C" void func_ov082_02212d90(void *a) {
    if (F(u32, a, 0x14) & 0x200000)
        return;
    F(u32, a, 0x14) = ((u16)(F(s16, a, 0xd6) - 5) <= 1)
                          ? F(u32, a, 0x14) | 0x40
                          : F(u32, a, 0x14) & ~0x40u;
    ActorExtendedType2_UpdateFrame(a);
    if (F(u32, a, 0x14) & 0x40) {
        F(s32, a, 0x44) = 0;
        s32 base = F(s32, a, 0x238) + 0x28000;
        F(s32, a, 0x24) = fxmul(F(s32, a, 0x24), 0xfae) + fxmul(base, 0x52);
        if (ActorExtendedType2_GetDescriptorValue25(a) >= 0) {
            ++F(u16, a, 0x298);
            if (!F(s16, a, 0xda) &&
                F(u16, a, 0x298) > ActorExtendedType2_GetDescriptorValue2A(a) &&
                SignedAbsoluteValue(F(s32, a, 0x24) - base) < 0x4000) {
                void *child = TrackedResourceActor_SpawnFromKey(
                    ActorExtendedType2_GetDescriptorValue25(a), (u8 *)a + 0x18,
                    (u8 *)a + 0x18);
                if (child)
                    F(s32, child, 0x44) = 0x1000;
                F(s16, a, 0xda) = 1;
                F(u32, a, 0xd0) |= 0x1000;
            }
        }
    }
    if (pair_is(a, data_ov082_022145e8, 8, data_ov082_022145f0)) {
        s32 h = Actor_GetCachedTerrainHeight(a);
        if (F(s32, a, 0x24) < h) {
            F(s32, a, 0x24) = h;
            F(s32, a, 0x44) = 0;
        }
    ...
    s32 lo = F(s32, a, 0x238), hi = lo + 0x2e000;
    if (F(s32, a, 0x24) < lo) {
        F(s32, a, 0x24) = lo;
        F(s32, a, 0x44) = 0;
    } else if (F(s32, a, 0x24) >= hi)
        F(s32, a, 0x24) = hi;
    if (ActorExtendedType2_GetDescriptorValue2C(a) == 1) {
        if (F(s32, a, 0x24) < lo + 0x16000) {
            F(u32, a, 0x14) &= ~0x80u;
            F(u32, a, 0x5c) &= 0xffff0000u;
        } else {
            F(u32, a, 0x14) |= 0x80;
            F(u32, a, 0x5c) = (F(u32, a, 0x5c) & 0xffff0000u) | 0xff80;
            F(u8, F(void *, a, 0x54), 0x3a) = 1;
        }
        if (F(s32, a, 0x24) < lo + 0x22000)
            F(u32, a, 0x14) &= ~0x100u;
        else
            F(u32, a, 0x14) |= 0x100;
    }
...
/* Report the optional action unsupported. */ extern "C" s32
func_ov082_02213058(void) {
    return 0;
}
/* Copy another actor position into an output vector. */ extern "C" void
func_ov082_02213060(void *out, void *a) {
    VecFx32Object_InitCopy(out, (u8 *)a + 0x18);
}
/* Expose inherited capability bit 0x80. */ extern "C" u32
func_ov082_02213070(void *a) {
    return F(u32, a, 0xd0) & 0x80;
}
/* Report inherited capability bit 0x40. */ extern "C" bool
func_ov082_0221307c(void *a) {
    return (F(u32, a, 0xd0) & 0x40) != 0;
}
/* Report no secondary interaction action. */ extern "C" s32
func_ov082_02213090(void) {
    return 0;
}
...
/* Return the fixed descriptor width. */ extern "C" s32
func_ov082_022130a0(void) {
    return 0x10;
}
/* Return the embedded position object. */ extern "C" void *
func_ov082_022130a8(void *a) {
    return (u8 *)a + 0x18;
}
/* Return the fixed interaction radius. */ extern "C" s32
func_ov082_022130b0(void) {
    return 0xc0000;
}
/* Forward a position update with mode zero. */ extern "C" void
func_ov082_022130b8(void *a, void *p) {
    ((V2)vm(a, 0x108))(a, p, 0);
}
/* Forward the alternate position update with mode zero. */ extern "C" void
func_ov082_022130d0(void *a, void *p) {
    ((V2)vm(a, 0x108))(a, p, 0);
}
/* Report no tertiary query result. */ extern "C" s32
func_ov082_022130e8(void) {
    return 0;
}
/* Enable inherited attachment flag 0x10. */ extern "C" void
func_ov082_022130f0(void *a) {
    F(u32, a, 0x260) |= 0x10;
}
/* Report a completed armed transition while vmethod 0xa8 is idle. */
extern "C" bool func_ov082_02213100(void *a) {
    return (F(u32, a, 0x260) & 8) && (F(u32, a, 0x260) & 2) &&
           ((M0)vm(a, 0xa8))(a) == 0;
}
/* Report descriptor byte mode eight. */ extern "C" bool
func_ov082_02213148(void *a) {
    return F(u8, a, 0x24c) == 8;
}
/* Report every animation state except 0x10 eligible. */ extern "C" bool
func_ov082_0221315c(void *a) {
    return F(s16, a, 0xd6) != 0x10;
}
/* Report vertical motion states five or six. */ extern "C" bool
func_ov082_0221317c(void *a) {
    return F(s16, a, 0xd6) == 5 || F(s16, a, 0xd6) == 6;
}
/* Report secondary animation states nine or ten. */ extern "C" bool
func_ov082_02213194(void *a) {
    return F(s16, a, 0xd8) == 9 || F(s16, a, 0xd8) == 10;
}
/* Report primary animation states nine or ten. */ extern "C" bool
func_ov082_022131ac(void *a) {
...
func_ov082_022131cc(void *a, s32 show) {
...
/* Return the fixed presentation alpha. */ extern "C" s32
func_ov082_02213210(void) {
    return 0x100;
}

/* Construct the attachment-producing actor and clear its local timers. */
extern "C" void *func_ov082_02213218(void *a, const void *c) {
    ActorExtendedType2_Init(a, c);
    F(void *, a, 0) = data_ov082_022148d0;
    F(u16, a, 0x298) = 0;
    F(u16, a, 0x29a) = F(u16, a, 0x29c) = 0;
    F(u32, a, 0x260) &= ~8u;
    return a;
}
/* Destroy the attachment actor while retaining allocation. */ extern "C" void *
func_ov082_02213274(void *a) {
    ActorExtendedType2_Destroy(a);
    return a;
}
/* Destroy and free the attachment actor. */ extern "C" void *
func_ov082_02213288(void *a) {
    ActorExtendedType2_Destroy(a);
    Heap_Free(a);
    return a;
}
/* Forward a descriptor and arm supported attachment types. */ extern "C" void
func_ov082_022132a4(void *a, void *d) {
    ((V2)vm(a, 0x108))(a, d, 0);
    s32 k = ActorExtendedType2_GetDescriptorValue25(a);
    if (k == 0 || k == 2)
        func_ov082_0221340c(a);
}
/* Emit the five-particle completion burst and attachment-specific sound. */
extern "C" void func_ov082_022132e8(void *a) {
...
extern "C" s32 func_ov082_0221340c(void *a) {
    if ((F(u16, a, 0x298) & 1) || ((M0)vm(a, 0xa8))(a) != 0 ||
        (F(u32, a, 0xd0) & 0x100))
        return 0;
    F(u16, a, 0x298) |= 1;
    F(u16, a, 0x29a) = (u16)ActorExtendedType2_GetDescriptorValue2A(a);
    F(s16, a, 0xda) = 0;
    F(u32, a, 0xd0) |= 0x1000;
    F(u32, a, 0x260) |= 8;
    F(u32, a, 0x10) &= ~0x10000u;
    set_pair(a, data_ov082_0221483c, 8);
...
extern "C" void func_ov082_022134f8(void *a, void *d) {
...
extern "C" void func_ov082_02213538(void *a, void *other, s32 q) {
    if (!ActorRuntimeCollection_GetPendingAttachmentFlag(
        ...
        ((F(u16, a, 0x298) >> 1) == 0) && !(F(u32, a, 0x260) & 8) &&
        (F(u8, other, 0x4d) == 1 || F(u8, other, 0x4d) == 7)) {
        F(u16, a, 0x298) = (F(u16, a, 0x298) & 1) | 0x78;
        ...
        if (m > 0x1000) {
            ...
            u8 impulse[16];
            VecFx32Object_InitComponents(impulse, func_020adc90(dx, m),
                                         func_020adc90(dy, m), 0);
            ((V2)vm(a, 0xb8))(a, impulse, 1);
            if (F(u8, other, 0x4d) == 1) {
                func_ov082_0221391c(impulse, -0x2000);
                ((V2)vm(other, 0xb8))(other, impulse, 1);
                if (record)
                    ActorDerivedType1_StartRecord(other, 0x84);
            } else {
                func_ov082_0221391c(impulse, -0x1000);
                ((V2)vm(other, 0xb8))(other, impulse, 1);
            }
...
/* Scale all vector payload components by a 20.12 scalar. */ extern "C" void
func_ov082_0221391c(void *v, s32 k) {
    F(s32, v, 4) = fxmul(F(s32, v, 4), k);
    F(s32, v, 8) = fxmul(F(s32, v, 8), k);
    F(s32, v, 12) = fxmul(F(s32, v, 12), k);
}
/* Construct a vector holding lhs minus rhs. */ extern "C" void
func_ov082_02213974(void *out, const void *l, const void *r) {
    VecFx32Object_Init(out);
    func_020adfbc((u8 *)l + 4, (u8 *)r + 4, (u8 *)out + 4);
}
/* Construct a vector divided by a scalar. */ extern "C" void
func_ov082_022139ac(void *out, const void *v, s32 d) {
    VecFx32Object_Init(out);
    F(s32, out, 4) = func_020adc90(F(s32, v, 4), d);
    F(s32, out, 8) = func_020adc90(F(s32, v, 8), d);
    F(s32, out, 12) = func_020adc90(F(s32, v, 12), d);
}
/* Construct a vector holding lhs plus rhs. */ extern "C" void
func_ov082_022139f4(void *out, const void *l, const void *r) {
    VecFx32Object_Init(out);
    func_020adff0((u8 *)l + 4, (u8 *)r + 4, (u8 *)out + 4);
}

/* Reload resources and select attachment animation and loop flags. */
extern "C" void func_ov082_02213a2c(void *a, s32, s32, s32) {
    void *r = F(void *, a, 0x208 + ((F(u16, a, 0x298) & 1) ? 4 : 0)),
         *s = F(void *, a, 0x54);
    s32 n = -1;
    bool reload = false, stop = false;
    u16 alpha = 0x100;
    if (F(s16, a, 0xda) == 1) {
        n = (F(u16, a, 0x298) & 1) ? 0x14 : 0x15;
        reload = stop = true;
    } else if (F(s16, a, 0x29c)) {
        n = F(u8, a, 0xd4) + 0x16;
        reload = stop = true;
    } else
        switch (F(s16, a, 0xd6)) {
        ...
        case 0x12:
            ...
            break;
        case 0x13:
            n = data_020e6adc[F(u16, a, 0x4e)] ? 0x14 : 0;
            reload = true;
            stop = data_020e6adc[F(u16, a, 0x4e)] != 0;
            break;
        case 0x14:
            n = 0;
            reload = true;
...
extern "C" void func_ov082_02213f64(void *a) {
    if (F(u32, a, 0x14) & 0x200000)
        return;
    u16 count = F(u16, a, 0x298) >> 1;
    if (count)
        F(u16, a, 0x298) = (F(u16, a, 0x298) & 1) | ((count - 1) << 1);
    if (F(u16, a, 0x298) & 1) {
        F(u32, a, 0x260) = (F(u32, a, 0x260) & ~0x400u) | 8;
        F(u32, a, 0x10) &= ~0x10000u;
        if (F(s16, a, 0x29a))
            --F(s16, a, 0x29a);
        s32 total = ActorExtendedType2_GetDescriptorValue2A(a);
        if (total - 30 < F(s16, a, 0x29a) &&
        ...
        if (!F(s16, a, 0x29a)) {
            bool ready = (F(u32, a, 0x260) & 2) && ((M0)vm(a, 0xa8))(a) == 0;
            if (ready) {
                F(u16, a, 0x298) &= ~1u;
                F(u32, a, 0xd0) |= 0x1000;
                F(s16, a, 0xda) = 0;
                set_pair(a, data_ov082_0221483c, 0x30);
        ...
        F(u32, a, 0x260) &= ~8u;
        if (!F(s16, a, 0x29c) && (F(u32, a, 0x260) & 0x10)) {
            F(s16, a, 0x29c) = 30;
            F(u32, a, 0x10) |= 0x10000;
            F(u32, a, 0xd0) |= 0x1000;
        }
        if (!F(s16, a, 0x29c))
            F(u32, a, 0x260) &= ~0x400u;
        else {
            F(u32, a, 0x260) |= 0x400;
            if (!--F(s16, a, 0x29c)) {
                F(u32, a, 0xd0) |= 0x1000;
...
/* Advance transition and clear active attachment on completion. */
extern "C" s32 func_ov082_02214248(void *a) {
    if (ActorExtendedType2_UpdateTimedAttachmentTransition(a)) {
        F(u16, a, 0x298) &= ~1u;
        return 1;
    }
    return 0;
}
/* Restore saved flags and install normal reentry callbacks. */ extern "C" s32
func_ov082_02214278(void *a) {
    Actor_RestoreSavedFlags(a);
    F(u32, a, 0x10) &= ~0x1f0000u;
    set_pair(a, data_ov082_0221483c, 0x18);
    F(void *, a, 0x220) = F(void *, data_ov082_0221483c, 0x28);
    F(void *, a, 0x224) = F(void *, data_ov082_0221483c, 0x2c);
    F(u32, a, 0xd0) &= ~0x200u;
    F(s16, a, 0xd6) = 2;
    return 0;
}
/* Complete animation and return to the idle callback set. */ extern "C" s32
func_ov082_022142d4(void *a) {
    F(u32, a, 0x260) &= ~3u;
    if (!F(s16, a, 0xda))
        F(s16, a, 0xda) = 1;
    else if (F(u16, F(void *, a, 0x54), 0x24) & 1) {
        set_pair(a, data_ov082_0221483c, 0x30);
        F(void *, a, 0x220) = F(void *, data_ov082_0221483c, 0x20);
        F(void *, a, 0x224) = F(void *, data_ov082_0221483c, 0x24);
        F(s16, a, 0xda) = 0;
...
/* Initialize reentry and refresh a long active countdown. */ extern "C" void
func_ov082_02214358(void *a) {
    ActorExtendedType2_InitializeReentryState(a);
    if (F(s32, a, 0x1fc) > 0 && (F(u16, a, 0x298) & 1))
        F(s16, a, 0x29a) = 360;
}
/* Return the first fixed range. */ extern "C" s32 func_ov082_0221438c(void) {
    return 0x800;
}
/* Return the second fixed range. */ extern "C" s32 func_ov082_02214394(void) {
    return 0x800;
}
/* Forward vmethod 0x1bc notification. */ extern "C" void
func_ov082_0221439c(void *a) {
    ((V0)vm(a, 0x1bc))(a);
}
/* Construct the paired follower and clear its partner. */ extern "C" void *
func_ov082_022143b0(void *a, const void *c) {
    ActorExtendedType2_Init(a, c);
    F(void *, a, 0) = data_ov082_02214b18;
    F(void *, a, 0x298) = 0;
    return a;
}
/* Destroy paired follower while retaining allocation. */ extern "C" void *
func_ov082_022143d8(void *a) {
    ActorExtendedType2_Destroy(a);
    return a;
}
/* Destroy and free paired follower. */ extern "C" void *
func_ov082_022143ec(void *a) {
    ActorExtendedType2_Destroy(a);
    Heap_Free(a);
    return a;
}
...
func_ov082_02214430(void *a, void *d) {
    F(u32, a, 0x260) |= 3;
    void *p = F(void *, a, 0x298);
    if (!p) {
        ((V0)vm(a, 0xe8))(a);
        return 0;
    }
    F(u8, a, 0x24c) = ActorExtendedType2_GetDescriptorValue2A(a) ? 0 : 0xb;
    if (((M0)vm(a, 0x38))(a))
        return 0;
    if (F(u16, d, 0x1a) & 2)
        set_pair(a, data_ov082_02214aac, 8);
    else
        ((V1)vm(a, 0xd0))(a, (u8 *)p + 0x18);
    return 0;
}
/* Follow a live partner for selected states, then run base frame. */
extern "C" void func_ov082_022144e8(void *a) {
    if (F(u32, a, 0x14) & 0x200000)
        return;
    bool first = pair_is(a, data_ov082_02214aac, 0x18, data_ov082_02214ac4),
         second = pair_is(a, data_ov082_02214aac, 0x10, data_ov082_02214abc);
    if ((first || second) && F(void *, a, 0x298))
        ((V1)vm(a, 0xe0))(a, F(void *, a, 0x298));
    ActorExtendedType2_UpdateFrame(a);
}
