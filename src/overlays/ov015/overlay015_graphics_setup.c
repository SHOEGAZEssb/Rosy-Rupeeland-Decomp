...
extern void GraphicsBgMapResource_AddPaletteBankOffset(void *,s32);extern void func_020b44e8(void);extern void GraphicsResourceSet_ApplyToMainBg(Overlay015ResourceSet *,s32,s32);extern void GraphicsBgCharacterResource_UploadToSubBg(void *,s32,s32);extern void GraphicsBgPaletteResource_UploadToSubBg(void *,s32);extern void GraphicsBgMapResource_UploadToSubBg(void *,s32,s32);
#ifdef __cplusplus
}
#endif
...
extern "C" void func_ov015_021fd41c(void *state)
{
    ...
    GraphicsResourceSet_Load(&a,data_020f4e18,0x8008,0x8009,0x800a);GraphicsResourceSet_Load(&b,data_020f4e18,0x8008,0x8009,0x800e);GraphicsResourceSet_Load(&c,data_020f4e18,0x8008,0x8009,0x800d);func_020b44e8();GraphicsResourceSet_ApplyToMainBg(&a,2,0);
    if(FIELD(s32,state,0xec)==0){GraphicsBgCharacterResource_UploadToSubBg((void *)a.words[0],0,0);GraphicsBgPaletteResource_UploadToSubBg((void *)a.words[1],0);GraphicsBgMapResource_UploadToSubBg((void *)b.words[2],0,0);GraphicsBgMapResource_UploadToSubBg((void *)c.words[2],1,0);}GraphicsResourceSet_Destroy(&c);GraphicsResourceSet_Destroy(&b);GraphicsResourceSet_Destroy(&a);
}
