...
extern "C" {
#endif
extern void func_020755bc(void *);extern void func_020925a4(s32);extern void func_020925f8(void);extern void func_02092638(s32,s32,s32,s32);extern void func_020925dc(s32);extern void func_02092618(void);extern void func_02092688(s32,s32,s32,s32);
...
extern "C" void func_ov015_021fd41c(void *state)
{
    ...
    func_020755bc(data_020f4e14);if(FIELD(s32,state,0xec)==0)func_020755bc(gDebugFont);*power&=(u16)~0x8000;FIELD(s32,state,0x48)=0x14;func_020925a4(0);mainBg[0]=(mainBg[0]&0x43)|0x3a00;mainBg[1]=(mainBg[1]&0x43)|0x1c00;func_020925f8();*(volatile u32 *)0x04000018=0x200000;func_02092638(0,1,2,3);
