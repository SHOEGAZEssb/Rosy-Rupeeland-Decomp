...
/* Recovered overlay 533 category-two actor-registration subsystem. */
...
extern u8 data_ov533_02234800[];
extern GamePhaseRegionTable data_ov533_02234804;
extern ActorScriptBytecode data_ov533_022344fa[];
extern ActorSpawnDescriptor data_ov533_02233ca0[];
...
void func_ov533_02233c60(void)
{
    ActorDescriptorBatch_RegisterAndSpawnCategory2(
        data_ov533_02234800, 3, data_ov533_02233ca0);
    ActorDescriptorBatch_SetCategory2Callback(data_ov533_022344fa);
    GamePhaseRegionTable_PublishActive(&data_ov533_02234804);
}
