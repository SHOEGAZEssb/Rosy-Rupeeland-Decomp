/*
 * Recovered overlay 278 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov278_0221d72c[], data_ov278_0221d740[];
extern unsigned char data_ov278_0221ea71[], data_ov278_02224000[];
extern unsigned char data_ov278_02224004[];
...
void func_ov278_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov278_02224004, 3, data_ov278_0221d740);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov278_0221d72c);
    ActorDescriptorBatch_SetCategory1Callback(data_ov278_0221ea71);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov278_0221d72c[];
extern unsigned char data_ov278_0221d740[];
extern unsigned char data_ov278_0221ea71[];
extern unsigned char data_ov278_02224000[];
extern unsigned char data_ov278_02224004[];
