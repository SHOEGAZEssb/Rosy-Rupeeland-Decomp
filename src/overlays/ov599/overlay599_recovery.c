...
/* Recovered overlay 599 category-two actor-registration subsystem. */
...
extern u8 data_ov599_022344a0[];
extern GamePhaseRegionTable data_ov599_022344a4;
extern ActorScriptBytecode data_ov599_02234496[];
extern ActorSpawnDescriptor data_ov599_02233ca0[];
...
void func_ov599_02233c60(void)
{
    ActorDescriptorBatch_RegisterAndSpawnCategory2(
        data_ov599_022344a0, 3, data_ov599_02233ca0);
    ActorDescriptorBatch_SetCategory2Callback(data_ov599_02234496);
    GamePhaseRegionTable_PublishActive(&data_ov599_022344a4);
}
