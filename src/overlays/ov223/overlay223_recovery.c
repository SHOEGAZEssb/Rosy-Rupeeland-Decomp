/*
 * Recovered overlay 223 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov223_0221d720[], data_ov223_0221d734[];
extern unsigned char data_ov223_0221e35d[], data_ov223_02224d80[];
extern unsigned char data_ov223_02224d84[];
...
void func_ov223_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov223_02224d84, 3, data_ov223_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov223_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov223_0221e35d);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov223_0221d720[];
extern unsigned char data_ov223_0221d734[];
extern unsigned char data_ov223_0221e35d[];
extern unsigned char data_ov223_02224d80[];
extern unsigned char data_ov223_02224d84[];
