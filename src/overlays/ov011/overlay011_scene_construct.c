...
extern void Scene_Init(void *); extern void Scene_SetFlags03(void *); extern void SceneInputBase_Init(void *); extern void func_02092364(void *); extern void func_020923a4(void *); extern void GraphicsSpriteRenderer_ClearTextBuffer(void *);
...
void *func_ov011_021fce78(void *state)
{
    ...
    GraphicsResourceSet_Init((GraphicsResourceSet *)((u8 *)state+0x78));func_02092364((u8 *)state+0x98);FIELD(s32,state,0x74)=0;FIELD(s32,state,0x108)=0;FIELD(s32,state,0xcc)=0;GraphicsSpriteRenderer_ClearTextBuffer(data_020f4e14);GraphicsSpriteRenderer_ClearTextBuffer(gDebugFont);
