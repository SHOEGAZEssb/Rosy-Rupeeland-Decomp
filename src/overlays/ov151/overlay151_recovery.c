/*
 * Recovered overlay 151 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov151_0221d720[], data_ov151_0221d730[];
extern unsigned char data_ov151_0221d744[], data_ov151_0221efa2[];
extern unsigned char data_ov151_02225660[];
...
void func_ov151_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov151_0221d720, 15, data_ov151_0221d744);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov151_0221d730);
    ActorDescriptorBatch_SetCategory1Callback(data_ov151_0221efa2);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov151_0221d720[];
extern unsigned char data_ov151_02225660[];
