/*
 * Recovered overlay 257 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov257_0221d720[], data_ov257_0221d734[];
extern unsigned char data_ov257_0221ee41[], data_ov257_02220520[];
extern unsigned char data_ov257_02220524[];
...
void func_ov257_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov257_02220524, 3, data_ov257_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov257_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov257_0221ee41);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov257_0221d720[];
extern unsigned char data_ov257_0221d734[];
extern unsigned char data_ov257_0221ee41[];
extern unsigned char data_ov257_02220520[];
extern unsigned char data_ov257_02220524[];
