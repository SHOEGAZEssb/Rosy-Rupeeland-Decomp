/*
 * Recovered overlay 169 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov169_0221d720[], data_ov169_0221d734[];
extern unsigned char data_ov169_0221f05d[], data_ov169_02222c00[];
extern unsigned char data_ov169_02222c04[];
...
void func_ov169_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov169_02222c04, 3, data_ov169_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov169_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov169_0221f05d);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov169_0221d720[];
extern unsigned char data_ov169_BSSSTART[];
