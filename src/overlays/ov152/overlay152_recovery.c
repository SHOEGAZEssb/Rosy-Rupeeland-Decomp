/*
 * Recovered overlay 152 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov152_0221d720[], data_ov152_0221d74c[];
extern unsigned char data_ov152_0221e51e[], data_ov152_02222fc0[];
...
void func_ov152_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov152_02222fc0, 3, data_ov152_0221d74c);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov152_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov152_0221e51e);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov152_0221d720[];
extern unsigned char data_ov152_02222fc0[];
