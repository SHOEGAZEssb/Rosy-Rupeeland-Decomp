/*
 * Recovered overlay 155 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov155_0221d77c[], data_ov155_0221d790[];
extern unsigned char data_ov155_0221e936[], data_ov155_02226ca0[];
extern unsigned char data_ov155_02226ca4[];
...
void func_ov155_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov155_02226ca4, 3, data_ov155_0221d790);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov155_0221d77c);
    ActorDescriptorBatch_SetCategory1Callback(data_ov155_0221e936);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov155_0221d720[];
extern unsigned char data_ov155_02226ca0[];
