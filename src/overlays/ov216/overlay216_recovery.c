...
extern unsigned char data_ov216_0221d720[], data_ov216_0221d734[];
extern unsigned char data_ov216_0221f3a0[], data_ov216_02224660[];
...
void func_ov216_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov216_02224664, 3, data_ov216_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov216_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov216_0221f3a0);
}
