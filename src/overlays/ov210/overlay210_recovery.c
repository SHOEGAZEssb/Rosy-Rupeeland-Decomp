...
extern unsigned char data_ov210_0221d720[], data_ov210_0221d734[];
extern unsigned char data_ov210_0221ef9b[], data_ov210_02227000[];
...
void func_ov210_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov210_02227004, 3, data_ov210_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov210_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov210_0221ef9b);
}
