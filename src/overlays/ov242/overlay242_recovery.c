...
extern unsigned char data_ov242_0221d720[], data_ov242_0221e2e8[];
extern unsigned char data_ov242_0221e289[], data_ov242_0221e2e0[];
...
void func_ov242_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov242_0221e2e4, 3, data_ov242_0221e2e8);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov242_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov242_0221e289);
}
