...
extern "C" void func_ov021_021fd790(void *state)
{
    (void)state;
}
 ...
 */
extern "C" void func_ov021_021fd794(void *state)
{
    FIELD(s32, state, 8) = 0;
    FIELD(s32, state, 4) = 0;
    FIELD(s32, state, 0) = 0;
 ...
 */
extern "C" void func_ov021_021fd7a8(void *state, void *a, void *b,
                                     void *c, void *d)
{
 ...
 */
extern "C" void func_ov021_021fd7c0(void *state, void *arg1, void *arg2)
{
