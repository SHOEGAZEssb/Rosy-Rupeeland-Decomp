/*
 * Recovered overlay 247 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov247_0221d720[], data_ov247_0221d734[];
extern unsigned char data_ov247_022207fd[], data_ov247_02221160[];
extern unsigned char data_ov247_02221164[];
...
void func_ov247_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov247_02221164, 3, data_ov247_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov247_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov247_022207fd);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov247_0221d720[];
extern unsigned char data_ov247_0221d734[];
extern unsigned char data_ov247_022207fd[];
extern unsigned char data_ov247_02221160[];
extern unsigned char data_ov247_02221164[];
