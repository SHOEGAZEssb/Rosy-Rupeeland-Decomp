...
/* Recovered overlay 479 category-two actor-registration subsystem. */
...
extern u8 data_ov479_022347a0[];
extern GamePhaseRegionTable data_ov479_022347a4;
extern ActorScriptBytecode data_ov479_02234496[];
extern ActorSpawnDescriptor data_ov479_02233ca0[];
...
void func_ov479_02233c60(void)
{
    ActorDescriptorBatch_RegisterAndSpawnCategory2(
        data_ov479_022347a0, 3, data_ov479_02233ca0);
    ActorDescriptorBatch_SetCategory2Callback(data_ov479_02234496);
    GamePhaseRegionTable_PublishActive(&data_ov479_022347a4);
}
