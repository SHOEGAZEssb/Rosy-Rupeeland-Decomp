/*
 * Recovered overlay 198 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov198_0221d720[], data_ov198_0221d734[], data_ov198_0221e370[], data_ov198_02220b20[], data_ov198_02220b24[];
...
void func_ov198_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov198_02220b24, 3, data_ov198_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov198_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov198_0221e370);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov198_0221d720[];
extern unsigned char data_ov198_BSSSTART[];
