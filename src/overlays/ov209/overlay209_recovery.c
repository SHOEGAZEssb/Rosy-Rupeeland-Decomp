/*
 * Recovered overlay 209 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov209_0221d720[], data_ov209_0221d734[];
extern unsigned char data_ov209_0221eaeb[], data_ov209_0222e340[];
extern unsigned char data_ov209_0222e344[];
...
void func_ov209_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov209_0222e344, 3, data_ov209_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov209_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov209_0221eaeb);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov209_0221d720[];
extern unsigned char data_ov209_0221d734[];
extern unsigned char data_ov209_0221eaeb[];
extern unsigned char data_ov209_0222e340[];
extern unsigned char data_ov209_0222e344[];
