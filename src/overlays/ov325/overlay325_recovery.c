...
extern unsigned char data_ov325_0221d720[], data_ov325_0221d734[];
extern unsigned char data_ov325_0221e939[], data_ov325_02226100[];
...
void func_ov325_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov325_02226104, 3, data_ov325_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov325_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov325_0221e939);
}
