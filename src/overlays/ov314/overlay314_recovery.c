...
extern unsigned char data_ov314_0221d72c[], data_ov314_0221d740[];
extern unsigned char data_ov314_0221f4b4[], data_ov314_02224c20[];
...
void func_ov314_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov314_02224c24, 3, data_ov314_0221d740);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov314_0221d72c);
    ActorDescriptorBatch_SetCategory1Callback(data_ov314_0221f4b4);
}
