...
extern unsigned char data_ov288_0221d734[], data_ov288_0221d748[];
extern unsigned char data_ov288_0221f249[], data_ov288_022257e4[];
...
void func_ov288_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov288_022257e0, 3, data_ov288_0221d748);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov288_0221d734);
    ActorDescriptorBatch_SetCategory1Callback(data_ov288_0221f249);
}
