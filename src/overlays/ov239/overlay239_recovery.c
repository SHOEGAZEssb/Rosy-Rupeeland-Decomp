...
extern unsigned char data_ov239_0221d72c[], data_ov239_0221d740[];
extern unsigned char data_ov239_0221e945[], data_ov239_02220ea0[];
...
void func_ov239_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov239_02220ea4, 3, data_ov239_0221d740);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov239_0221d72c);
    ActorDescriptorBatch_SetCategory1Callback(data_ov239_0221e945);
}
