 ...
 * data_ov005_021fca08 to func_ov005_021fbe44. Return zero in all cases. Any
 * state changes are delegated to that helper; no hardware access occurs here.
 */
#ifdef __cplusplus
extern "C"
#endif
s32 func_ov005_021fc610(void *state)
{
    if (*(s32 *)((u8 *)state + 0x04) == 0) {
        func_ov005_021fbe44(state, data_ov005_021fca08[0],
