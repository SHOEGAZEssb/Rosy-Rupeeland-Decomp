 ...
 * and for auxiliary +0x78 call AreaInfoPanelPresentation_Destroy then Heap_Free. For scene +0x74,
 * call func_ov005_021fbb78 then Heap_Free. Submit zero to TitleDisplay_ConfigureSub2dEngine, clear
