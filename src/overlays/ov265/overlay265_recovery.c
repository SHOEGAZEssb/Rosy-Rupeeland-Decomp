/*
 * Recovered overlay 265 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov265_0221d730[], data_ov265_0221d744[];
extern unsigned char data_ov265_0221f4b8[], data_ov265_02225780[];
extern unsigned char data_ov265_02225784[];
...
void func_ov265_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov265_02225784, 3, data_ov265_0221d744);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov265_0221d730);
    ActorDescriptorBatch_SetCategory1Callback(data_ov265_0221f4b8);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov265_0221d730[];
extern unsigned char data_ov265_0221d744[];
extern unsigned char data_ov265_0221f4b8[];
extern unsigned char data_ov265_02225780[];
extern unsigned char data_ov265_02225784[];
