...
extern "C" s32 GraphicsCharacterResource_GetUploadSize(void *);
extern "C" s32 GraphicsPaletteResource_GetUploadSize(void *);
extern "C" u32 GraphicsCharacterResource_GetTextureFormat(void *);
extern "C" u32 GraphicsCharacterResource_GetTextureWidthExponent(void *);
extern "C" u32 GraphicsCharacterResource_GetTextureHeightExponent(void *);
                                      ...
                                      s32 y, s32 terminalFrame)
{
    ...
    if (kind == 1 || kind == 2 || (u32)(kind - 11) <= 3) {
        ...
        self->textureOffset30 = 0x20000 - GraphicsCharacterResource_GetUploadSize(self->model00);
        self->paletteOffset34 = 0x4000 - GraphicsPaletteResource_GetUploadSize(self->animation04);
        self->textureParam38 = GraphicsCharacterResource_GetTextureFormat(self->model00);
        self->textureWidth3c = GraphicsCharacterResource_GetTextureWidthExponent(self->model00);
        self->textureHeight40 = GraphicsCharacterResource_GetTextureHeightExponent(self->model00);
        func_020b239c();
        func_020b2238(*(void **)((u8 *)self->model00 + 0x24),
                       self->textureOffset30, GraphicsCharacterResource_GetUploadSize(self->model00));
        func_020b21c8();
        func_020b2180();
        func_020b210c(GraphicsBgResourceData_GetDecoded(self->animation04),
                       self->paletteOffset34, GraphicsPaletteResource_GetUploadSize(self->animation04));
        func_020b20b4();
