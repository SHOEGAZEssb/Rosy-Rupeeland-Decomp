/*
 * Recovered overlay 358 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov358_0221d720[], data_ov358_0221e289[];
extern unsigned char data_ov358_0221e2a0[], data_ov358_0221e2a4[];
extern unsigned char data_ov358_0221e2a8[];
...
void func_ov358_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov358_0221e2a4, 3, data_ov358_0221e2a8);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov358_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov358_0221e289);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov358_0221d720[];
extern unsigned char data_ov358_0221e289[];
extern unsigned char data_ov358_0221e2a0[];
extern unsigned char data_ov358_0221e2a4[];
extern unsigned char data_ov358_0221e2a8[];
