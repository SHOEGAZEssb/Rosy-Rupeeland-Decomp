...
/* Recovered overlay 421 category-two actor-registration subsystem. */
...
extern u8 data_ov421_022347a0[];
extern GamePhaseRegionTable data_ov421_022347a4;
extern ActorScriptBytecode data_ov421_022344fa[];
extern ActorSpawnDescriptor data_ov421_02233ca0[];
...
void func_ov421_02233c60(void)
{
    ActorDescriptorBatch_RegisterAndSpawnCategory2(
        data_ov421_022347a0, 3, data_ov421_02233ca0);
    ActorDescriptorBatch_SetCategory2Callback(data_ov421_022344fa);
    GamePhaseRegionTable_PublishActive(&data_ov421_022347a4);
}
