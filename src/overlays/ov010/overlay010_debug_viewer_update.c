...
extern void func_ov010_021fce94(void *,s32,s32,s32); extern void func_02076be8(void *,s32); extern void func_02076c20(void *,s32);
extern void func_020b0300(u16,s32,s32,s32,s32); extern void func_020773a8(void *);
#ifdef __cplusplus
}
#endif
 ...
 * recreate the active resource; animation calls use func_02076be8/func_02076c20.
 *
 ...
 * +0x4C/+0x34/+0x38/+0x52. Advance via func_020773a8 and synchronize +0x148
...
s32 func_ov010_021fd638(void *state)
{
    ...
    if(repeat&0x100){
        ...
        case 2:if((obj=FIELD(void *,state,0x8c))&&held&0x30){void *m=FIELD(void *,FIELD(void *,state,0x84),0x20);FIELD(s32,state,0x144)=func_ov010_021fd5a8(state,FIELD(s32,state,0x144),0,FIELD(s32,m,4)-1,1);func_02076be8(obj,(u8)FIELD(s32,state,0x144));}break;
        case 3:if((obj=FIELD(void *,state,0x8c))&&FIELD(s32,state,0x174)==0&&(held&0x30)){void *t=FIELD(void *,FIELD(void *,state,0x84),0x24);u8 *e=(u8 *)t+FIELD(s32,state,0x144)*8;FIELD(s32,state,0x148)=func_ov010_021fd5a8(state,FIELD(s32,state,0x148),0,FIELD(u16,e,2)-1,1);func_02076c20(obj,(u8)FIELD(s32,state,0x148));}break;
    ...
    func_020773a8(FIELD(void *,state,0x88));
