...
extern void GraphicsAnimationInstanceManager_DestroyInstance(void *, void *); extern void GraphicsResourceSetVariant_ReleaseHandles(void *);
#ifdef __cplusplus
}
#endif
...
void func_ov010_021fd408(void *state)
{
    ...
    FIELD(void *,state,0x8c)=0; GraphicsResourceSetVariant_ReleaseHandles((u8 *)state+0x7c);
}
