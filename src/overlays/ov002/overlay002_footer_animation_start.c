...
extern void TitleInterpolatedValue_Configure(void *animation, s32 mode, s32 duration, s32 start,
                          s32 end);
#ifdef __cplusplus
}
#endif
 ...
 * call TitleInterpolatedValue_Configure for animation_098 with arguments (1, 0x18, 0, 0x10).
...
void func_ov002_021fbdc0(Overlay002FooterAnimationState *state)
{
    ...
    TitleInterpolatedValue_Configure(state->animation_098, 1, 0x18, 0, 0x10);
}
