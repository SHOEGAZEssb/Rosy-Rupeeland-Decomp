/*
 * Recovered overlay 158 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov158_0221d720[], data_ov158_0221d734[];
extern unsigned char data_ov158_0221e9a2[], data_ov158_02229200[];
extern unsigned char data_ov158_02229204[];
...
void func_ov158_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov158_02229204, 3, data_ov158_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov158_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov158_0221e9a2);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov158_0221d720[];
extern unsigned char data_ov158_02229200[];
