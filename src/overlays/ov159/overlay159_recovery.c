/*
 * Recovered overlay 159 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov159_0221d720[], data_ov159_0221d734[];
extern unsigned char data_ov159_0221ed98[], data_ov159_02228760[];
extern unsigned char data_ov159_02228764[];
...
void func_ov159_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov159_02228764, 3, data_ov159_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov159_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov159_0221ed98);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov159_0221d720[];
extern unsigned char data_ov159_02228760[];
