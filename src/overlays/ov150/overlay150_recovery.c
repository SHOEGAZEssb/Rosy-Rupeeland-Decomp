/*
 * Recovered overlay 150 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov150_0221d720[], data_ov150_0221d730[];
extern unsigned char data_ov150_0221d744[], data_ov150_0221e89a[];
extern unsigned char data_ov150_02226760[];
...
void func_ov150_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov150_0221d720, 15, data_ov150_0221d744);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov150_0221d730);
    ActorDescriptorBatch_SetCategory1Callback(data_ov150_0221e89a);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov150_0221d720[];
extern unsigned char data_ov150_02226760[];
