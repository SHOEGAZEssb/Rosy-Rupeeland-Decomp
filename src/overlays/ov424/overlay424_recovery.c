...
/* Recovered overlay 424 category-two actor-registration subsystem. */
...
extern u8 data_ov424_022346a0[];
extern GamePhaseRegionTable data_ov424_022346a4;
extern ActorScriptBytecode data_ov424_02234432[];
extern ActorSpawnDescriptor data_ov424_02233ca0[];
...
void func_ov424_02233c60(void)
{
    ActorDescriptorBatch_RegisterAndSpawnCategory2(
        data_ov424_022346a0, 3, data_ov424_02233ca0);
    ActorDescriptorBatch_SetCategory2Callback(data_ov424_02234432);
    GamePhaseRegionTable_PublishActive(&data_ov424_022346a4);
}
