...
extern const char *LanguageLookupDatabase_GetResourceById(void *, s32);
#ifdef __cplusplus
}
#endif
                                     ...
                                     s32 numericValue)
{
    ...
    label = LanguageLookupDatabase_GetResourceById(data_021f3ecc,
    ...
    separator = LanguageLookupDatabase_GetResourceById(data_021f3ecc, 0x2d6);
    ...
    width = GraphicsSpriteRenderer_DrawText(gDebugFont,
                          LanguageLookupDatabase_GetResourceById(data_021f3ecc, 0x2d6), x + 2, 0x68,
                          0xe, 6, 0);
    x += width + 4;
