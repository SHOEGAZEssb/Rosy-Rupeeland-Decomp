...
extern unsigned char data_ov263_0221d734[], data_ov263_0221d748[];
extern unsigned char data_ov263_0221f520[], data_ov263_02224080[];
...
void func_ov263_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov263_02224084, 3, data_ov263_0221d748);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov263_0221d734);
    ActorDescriptorBatch_SetCategory1Callback(data_ov263_0221f520);
}
