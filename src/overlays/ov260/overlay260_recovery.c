/*
 * Recovered overlay 260 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov260_0221d720[], data_ov260_0221d734[];
extern unsigned char data_ov260_0222066d[], data_ov260_02220920[];
extern unsigned char data_ov260_02220924[];
...
void func_ov260_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov260_02220924, 3, data_ov260_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov260_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov260_0222066d);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov260_0221d720[];
extern unsigned char data_ov260_0221d734[];
extern unsigned char data_ov260_0222066d[];
extern unsigned char data_ov260_02220920[];
extern unsigned char data_ov260_02220924[];
