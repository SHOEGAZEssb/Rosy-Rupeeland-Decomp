...
extern "C" void func_ov025_021fe91c(void *object)
{
    ...
    case 1:
        if (FIELD(s32, object, 0xa4) != 0) {
            ...
            PresentationScalar_TransitionTo((u8 *)object + 0xc, 1, -0x20000);
        } else {
            func_ov025_021fe174(object, 1, 1, 0x42);
            PresentationScalar_TransitionTo((u8 *)object + 0xc, 1, 0x120000);
        }
        PresentationScalar_TransitionTo((u8 *)object + 0x1c, 3, 0x40000);
