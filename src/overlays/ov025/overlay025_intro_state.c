...
static void *create_row(s32 index)
{
...
extern "C" s32 func_ov025_022009d8(void *scene)
{
    ...
    case 1: {
        ...
        if (status == 0 || status == -1)
            break;
        for (s32 i = 0; i < 3; ++i)
            FIELD(void *, scene, 0xe4 + i * 4) = create_row(i);
    ...
    case 4: {
        ...
        if (FIELD(s32, row, 0x8c)) {
            func_ov025_02200224(scene, 0x22 + index, 0);
            advance_state(scene);
        } else if (++FIELD(s32, scene, 0x638) >= 3) {
            transition_pair(scene, (const u32 *)data_ov025_02202e38);
        }
        break;
    }
    case 5:
    ...
    case 6: {
        ...
        if (status == -1) {
            ...
            if (FIELD(s32, gRuntimeContext, 0x10) == 4) {
                ...
                transition_pair(scene, (const u32 *)data_ov025_02202e50);
            }
        } else {
    ...
    case 7:
        if (func_ov025_02200480(scene)) {
            ...
            FIELD(void *, scene, 0xe4 + index * 4) = create_row(index);
    ...
    case 8:
        if (func_02095dd4(FIELD(void *, scene, 0x59c), (u8 *)scene + 0x30,
            ...
            if (++FIELD(s32, scene, 0x638) >= 3)
                transition_pair(scene, (const u32 *)data_ov025_02202e00);
            else
                advance_state(scene);
        }
        break;
