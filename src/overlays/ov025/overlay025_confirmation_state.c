...
extern "C" s32 func_ov025_02201348(void *scene)
{
    ...
    case 1: {
        ...
        if (result == 3) {
            ...
            transition_pair(scene, (const u32 *)data_ov025_02202e58);
        } else if (result == 5) {
            func_ov025_02200224(scene, 0x1e, 0);
            transition_pair(scene, (const u32 *)data_ov025_02202ed0);
        }
        break;
    }
    case 2:
        if (func_ov025_02200480(scene)) {
            ...
            transition_pair(scene, (const u32 *)data_ov025_02202e80);
        }
        break;
    }
