/*
 * Recovered overlay 121 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov121_0221d720[], data_ov121_0221d770[];
extern unsigned char data_ov121_0221eb49[], data_ov121_02225b60[];
 ...
 */
void func_ov121_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov121_02225b60,
        3, data_ov121_0221d770);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov121_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov121_0221eb49);
}

/* Exact initialized records and zero-initialized work fields used by the overlay. */
extern unsigned char data_ov121_0221d720[];
extern unsigned char data_ov121_02225b60[];
