...
extern "C" s32 func_ov036_021ff9d0(void *controller)
{
    ...
    case 2:
        if (func_02091c7c((u8 *)controller + 0xa4, 2) != 0) {
            ...
            FIELD(u8, FIELD(void *, child, 0x9c), 0x5b) =
                (u8)func_02094d28(child, 1, 1, 0x1f);
    ...
    case 3:
        if (func_ov036_021fd28c(FIELD(void *, controller, 0xf8)) != 0) {
            ...
            func_02094cf0(FIELD(void *, controller, 0x100),
    ...
    case 4: {
        ...
        if (func_02095248(FIELD(void *, controller, 0x100)) != 0) {
            ...
            FIELD(s32, controller, 0xa0)++;
        } else if (func_02095224(FIELD(void *, controller, 0xd8)) == 0) {
            void *child = FIELD(void *, controller, 0xd8);
            FIELD(u8, FIELD(void *, child, 0x9c), 0x5b) =
                (u8)func_02094d28(child, 1, 0x1f, 1);
        }
        break;
    }
    ...
    case 5:
        if (func_02095248(FIELD(void *, controller, 0x100)) != 0) {
            func_02094cf0(FIELD(void *, controller, 0xec),
    ...
    case 6:
        if (func_02095248(FIELD(void *, controller, 0xec)) != 0) {
    ...
    case 8:
        if (func_02095224(FIELD(void *, controller, 0xec)) != 0) {
