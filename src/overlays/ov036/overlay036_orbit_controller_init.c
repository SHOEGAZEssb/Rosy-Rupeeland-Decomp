                                      ...
                                      void *argument)
{
    ...
    func_020720e8((u8 *)controller + 0xf4, data_020f4e18,
                  0x605a, 0x605b, 0x605c);
    func_020779ac(owner, (u8 *)controller + 0xf4);
    FIELD(void *, controller, 0x100) = func_02077624(owner);
