 ...
 * negated angle +0x60 select an adjacent pair in gFx32CosSinTable. Each component
...
extern "C" void func_ov036_02203228(void *controller)
{
    ...
    s32 projectedX =
        x + divide_by_256((s16)gFx32CosSinTable[index] * 0xe0);
    s32 projectedY =
        y + divide_by_256((s16)gFx32CosSinTable[index + 1] * 0xe0);
