...
extern void Presentation_InitVariant(void *field);
...
extern "C" void *func_ov036_02203850(void *object, void *resource)
{
    ...
    Presentation_InitVariant((u8 *)object + 0xb4);
    ...
    PresentationList_Append((u8 *)object + 0x9c, child);
    ...
    Presentation_SetPosition(child, 0x400, 0, 0);
    PresentationScalar_SetImmediate((u8 *)child + 0x6c, 0x400);
    PresentationList_Append((u8 *)object + 0x9c, child);
