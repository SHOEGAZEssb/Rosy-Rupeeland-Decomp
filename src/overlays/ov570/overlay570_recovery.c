...
/* Recovered overlay 570 category-two actor-registration subsystem. */
...
extern u8 data_ov570_02234380[];
extern GamePhaseRegionTable data_ov570_02234384;
extern ActorScriptBytecode data_ov570_0223436a[];
extern ActorSpawnDescriptor data_ov570_02233ca0[];
...
void func_ov570_02233c60(void)
{
    ActorDescriptorBatch_RegisterAndSpawnCategory2(
        data_ov570_02234380, 3, data_ov570_02233ca0);
    ActorDescriptorBatch_SetCategory2Callback(data_ov570_0223436a);
    GamePhaseRegionTable_PublishActive(&data_ov570_02234384);
}
