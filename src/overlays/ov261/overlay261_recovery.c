...
extern unsigned char data_ov261_0221d730[], data_ov261_0221d744[];
extern unsigned char data_ov261_0221f3f0[], data_ov261_02224200[];
...
void func_ov261_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov261_02224204, 3, data_ov261_0221d744);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov261_0221d730);
    ActorDescriptorBatch_SetCategory1Callback(data_ov261_0221f3f0);
}
