...
extern "C" void *func_02073ffc(void *resource, void *descriptor, s32 mode);
...
extern "C" void func_02074058(void *resource);
...
{
    void *binding = func_02073ffc(FIELD(void *, object, 0xbc),
                                  (u8 *)object + 0xc0, 1);
    FIELD(void *, object, 0xcc) = binding;
    func_02073e48(binding, 0, 0x84, 0x20, 2, 0, 2);
    binding = func_02073ffc(FIELD(void *, object, 0xbc),
                            (u8 *)object + 0xc0, 1);
...
/*
 * Clear the resource at +0xBC through func_02074058 and reset cached binding
...
{
    func_02074058(FIELD(void *, object, 0xbc));
