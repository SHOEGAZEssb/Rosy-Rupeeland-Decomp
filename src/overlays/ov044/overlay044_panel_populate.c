...
extern "C" s32 InventoryRecord_HasStatusBit1(void *record);
...
extern "C" void InventoryScroll_SetFirstVisibleRow(void *child, s32 index);
 ...
 * accepted by InventoryRecord_HasStatusBit1,
...
extern "C" void func_ov044_0220c440(void *object)
{
    ...
    for (s32 i = 0; i < total; ++i) {
        ...
        if (InventoryRecord_HasStatusBit1(record)) {
    ...
    for (s32 i = 0; i < acceptedSpan; ++i) {
        ...
        func_ov044_0220b944(panel, record,
                           InventoryRecord_HasStatusBit1(record) ? 0 : 1);
    }
    void *child = FIELD(void *, panel, 0x44);
    InventoryScroll_SetFirstVisibleRow(child, FIELD(s32, object, 0x230));
    InventoryScroll_SetSelectedRow(child, FIELD(s32, object, 0x234));
