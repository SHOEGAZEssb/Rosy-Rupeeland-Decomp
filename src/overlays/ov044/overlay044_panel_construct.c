...
extern "C" void *CxxArray_ConstructWithCookie(void *records, s32 count, s32 stride,
 ...
 * data_ov044_0220d330, construct records with InventoryCell_Init/020683f4, and store
...
extern "C" void *func_ov044_0220b740(void *object, void *font, s32 rowCount)
{
    ...
    TitleCharacterResourceCollection_Init((u8 *)object + 0x14);
    ...
    if (rowCount != 0) {
        ...
        if (records)
            records = CxxArray_ConstructWithCookie(records, rowCount, 0x20, 8,
