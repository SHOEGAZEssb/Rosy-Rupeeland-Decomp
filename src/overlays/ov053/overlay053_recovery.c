...
extern "C" void GraphicsResourceSet_Init(void*);extern "C" void GraphicsResourceSet_Load(void*,void*,s32,s32,s32);extern "C" void GraphicsResourceSet_ApplyToMainBg(void*,s32,s32);extern "C" void GraphicsResourceSet_ReleaseHandles(void*);extern "C" void GraphicsResourceSet_Apply(void*,s32,s32);extern "C" void GraphicsResourceSet_Destroy(void*);extern "C" void BgScroll_SetMainBg2(s32,s32);extern "C" void BgScroll_SetSubBg2(s32,s32);extern "C" void *data_020f4e18;
extern "C" void func_ov053_0220da60(void *){u32 set[3];GraphicsResourceSet_Init(set);GraphicsResourceSet_Load(set,data_020f4e18,0xa12f,0xa130,0xa131);GraphicsResourceSet_ApplyToMainBg(set,2,0);GraphicsResourceSet_ReleaseHandles(set);volatile u16*sub=(volatile u16*)0x0400100c;*sub=(*sub&0x43)|0x1a00;GraphicsResourceSet_Load(set,data_020f4e18,0xa12c,0xa12d,0xa12e);GraphicsResourceSet_Apply(set,2,0);volatile u32*disp=(volatile u32*)0x04001000;u32 planes=(*disp&0x1f00)>>8;*disp=(*disp&~0x1f00)|((planes|4)<<8);BgScroll_SetMainBg2(0,0);BgScroll_SetSubBg2(0,0);*(volatile u16*)0x0400000c&=(u16)~3;*(volatile u16*)0x0400100c&=(u16)~3;GraphicsResourceSet_Destroy(set);}
