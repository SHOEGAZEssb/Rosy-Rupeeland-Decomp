/*
 * Recovered overlay 286 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov286_0221d720[], data_ov286_0221d734[];
extern unsigned char data_ov286_0221ebf5[], data_ov286_02222720[];
extern unsigned char data_ov286_02222724[];
...
void func_ov286_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov286_02222724, 3, data_ov286_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov286_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov286_0221ebf5);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov286_0221d720[];
extern unsigned char data_ov286_0221d734[];
extern unsigned char data_ov286_0221ebf5[];
extern unsigned char data_ov286_02222720[];
extern unsigned char data_ov286_02222724[];
