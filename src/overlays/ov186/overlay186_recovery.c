/*
 * Recovered overlay 186 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov186_0221d720[], data_ov186_0221d734[];
extern unsigned char data_ov186_0221e39c[], data_ov186_02222e40[];
extern unsigned char data_ov186_02222e44[];
...
void func_ov186_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov186_02222e44, 3, data_ov186_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov186_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov186_0221e39c);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov186_0221d720[];
extern unsigned char data_ov186_BSSSTART[];
