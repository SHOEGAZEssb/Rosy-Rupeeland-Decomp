...
/*
 * Overlay 7 base-object construction. This recovered constructor installs the
 * shared descriptor, constructs two embedded members, and clears base state.
 */

typedef struct Overlay007BaseObject {
...
extern "C"
#endif
Overlay007BaseObject *func_ov007_021fb6e0(Overlay007BaseObject *state)
{
