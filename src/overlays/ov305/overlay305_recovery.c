/*
 * Recovered overlay 305 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov305_0221d720[], data_ov305_0221d734[];
extern unsigned char data_ov305_0221e275[], data_ov305_0221f6c0[];
extern unsigned char data_ov305_0221f6c4[];
...
void func_ov305_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov305_0221f6c4, 3, data_ov305_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov305_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov305_0221e275);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov305_0221d720[];
extern unsigned char data_ov305_0221d734[];
extern unsigned char data_ov305_0221e275[];
extern unsigned char data_ov305_0221f6c0[];
extern unsigned char data_ov305_0221f6c4[];
