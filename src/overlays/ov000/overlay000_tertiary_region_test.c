...
/*
 * Forward record to SpriteMotionController_BeginHitResponse for the tertiary embedded region, fixing its
...
s32 func_ov000_021fc5fc(Overlay000TertiaryRegionTestState *state,
                        const void *record)
{
    return SpriteMotionController_BeginHitResponse(state->region_17c, record, 4, 0);
}
