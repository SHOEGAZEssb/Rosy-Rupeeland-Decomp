                                         ...
                                         void *owner)
{
    ...
    func_02093a88(state->controllerState_270);
    ...
    func_02073e48(state->sprite_020, 2, 0x38, 0x38, 2, 0, 2);
    ...
    state->cells_250 = (u8 *)func_02003e20(
        roundedCount * 0x20 + 8, data_ov000_021fcd54, 4, &gHeapContext);
    if (state->cells_250 != 0) {
        func_020c09cc(state->cells_250, roundedCount, 0x20, 8,
    ...
    func_02093adc(state->controllerState_270, 0, 4, 0);
    return state;
}
