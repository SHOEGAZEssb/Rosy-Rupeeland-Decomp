...
extern "C" {
#endif
extern s32 ActorDescriptor_IsInvalid(void *cell);
#ifdef __cplusplus
}
#endif
 ...
 * cellContainer_24c+8. If ActorDescriptor_IsInvalid reports it ineligible, return without
                         ...
                         s32 clearField)
{
    void *cell = (u8 *)FIELD(void *, state->cellContainer_24c, 0x08) +
                 index * 0x24;
    if (ActorDescriptor_IsInvalid(cell) != 0) {
        return;
    }
