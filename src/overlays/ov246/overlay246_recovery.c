...
extern unsigned char data_ov246_0221d720[], data_ov246_0221d734[];
extern unsigned char data_ov246_02220735[], data_ov246_02221000[];
...
void func_ov246_0221d6c0(s32 phase)
{
    if (phase != 0) return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(data_ov246_02221004, 3, data_ov246_0221d734);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov246_0221d720);
    ActorDescriptorBatch_SetCategory1Callback(data_ov246_02220735);
}
