/*
 * Recovered overlay 280 compact interpreter-data subsystem.
 *
...
extern unsigned char data_ov280_0221d734[], data_ov280_0221d748[];
extern unsigned char data_ov280_0221f4a1[], data_ov280_0222b524[];
extern unsigned char data_ov280_0222b520[];
...
void func_ov280_0221d6c0(s32 phase)
{
    if (phase != 0)
        return;
    ActorInteractionRuntime_Init();
    ActorDescriptorBatch_RegisterAndSpawnCategory1(
        data_ov280_0222b520, 3, data_ov280_0221d748);
    ActorInteractionRuntime_NoOp();
    GamePhaseRuntime_SetGlobalValue30F8(data_ov280_0221d734);
    ActorDescriptorBatch_SetCategory1Callback(data_ov280_0221f4a1);
}

/* Exact initialized records and zero-initialized work storage used by the overlay. */
extern unsigned char data_ov280_0221d734[];
extern unsigned char data_ov280_0221d748[];
extern unsigned char data_ov280_0221f4a1[];
extern unsigned char data_ov280_0222b520[];
extern unsigned char data_ov280_0222b524[];
